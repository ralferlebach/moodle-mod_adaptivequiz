...
class start_attempt implements renderable, templatable {
    ...
    public function __construct(
        /** @var single_button $startbutton Button to start or continue an attempt, null when no attempt is possible. */
        private readonly ?single_button $startbutton = null,
        /** @var notification $notification Notification to show instead of the start button, null when none applies. */
