...
class item_bank_page implements renderable, templatable {
    ...
    public function __construct(
        ...
        /** @var item_bank_qbanks $qbanks Question banks linked as item bank. */
        private readonly item_bank_qbanks $qbanks,
        /** @var item_bank_qcategories $qcategories Question categories linked as item bank. */
        private readonly item_bank_qcategories $qcategories,
        /** @var item_administration_params $params Item administration parameters of the instance. */
