...
$string['completionvalidresultcminfo'] = 'Achieve a valid result';
$string['completionvalidresultform'] = 'Student must have at least one completed attempt with a valid result';
...
$string['modformcatmodel_help'] = 'Choose a CAT model subplugin to drive this activity. Leaving this empty uses the built-in adaptive algorithm. Changing the selection reloads the form, because the settings below depend on it.';
$string['modformcatmodelheader'] = 'CAT model';
$string['modformcatmodelnone'] = 'Built-in algorithm';
...
$string['modformsubmitcatmodeloption'] = 'Apply CAT model selection';
...
$string['privacy:metadata:adaptivequiz_attempt'] = 'Details of the attempts a user has made on an adaptive quiz, including the estimated ability.';
$string['privacy:metadata:adaptivequiz_attempt:attemptstate'] = 'Whether the attempt is in progress or completed.';
$string['privacy:metadata:adaptivequiz_attempt:attemptstopcriteria'] = 'The reason the attempt stopped.';
$string['privacy:metadata:adaptivequiz_attempt:difficultysum'] = 'The sum of the difficulty levels of the questions administered.';
$string['privacy:metadata:adaptivequiz_attempt:measure'] = 'The ability measured for the user in this attempt.';
$string['privacy:metadata:adaptivequiz_attempt:questionsattempted'] = 'The number of questions the user answered.';
$string['privacy:metadata:adaptivequiz_attempt:standarderror'] = 'The standard error of the measured ability.';
$string['privacy:metadata:adaptivequiz_attempt:timecreated'] = 'The time the attempt was started.';
$string['privacy:metadata:adaptivequiz_attempt:timemodified'] = 'The time the attempt was last changed.';
$string['privacy:metadata:adaptivequiz_attempt:uniqueid'] = 'The question usage that holds the answers given during the attempt.';
$string['privacy:metadata:adaptivequiz_attempt:userid'] = 'The user the attempt belongs to.';
$string['privacy:metadata:adaptivequizcatmodel'] = 'CAT model subplugins keep results of their own for an attempt, such as estimated abilities.';
$string['privacy:metadata:core_grades'] = 'The adaptive quiz stores the grade of an attempt in the gradebook.';
$string['privacy:metadata:core_question'] = 'The answers given during an attempt are stored by the question subsystem.';
$string['privacy:metadata:preference:answersdistributionchart'] = 'The chart settings a user chose for the answers distribution report.';
$string['privacy:metadata:preference:usersattemptsreport'] = 'The filter and paging settings a user chose for the users attempts report.';
...
$string['reportpageunavailableforcustomcatmodel'] = 'This page is not available when a custom CAT model is in use.';
