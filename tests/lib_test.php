...
class lib_test extends advanced_testcase {
    ...
    public function questioncat_association_records() {
        ...
        $adaptivequiz->questionpool = [1, 2, 3, 4];
        $data[] = [1, $adaptivequiz];

        $adaptivequiz = new stdClass();
        $adaptivequiz->questionpool = [1, 2];
        $data[] = [2, $adaptivequiz];

        $adaptivequiz = new stdClass();
        $adaptivequiz->questionpool = [1, 2, 4];
        $data[] = [3, $adaptivequiz];
    ...
    public function test_adaptivequiz_print_recent_mod_activity_details_true() {
        ...
        $output = adaptivequiz_print_recent_mod_activity($dummy, 1, true, ['mod_adaptivequiz' => 'adaptivequiz'], true, true);
    ...
    public function test_adaptivequiz_print_recent_mod_activity_details_false() {
        ...
        $output = adaptivequiz_print_recent_mod_activity($dummy, 1, false, ['mod_adaptivequiz' => 'adaptivequiz'], true, true);
