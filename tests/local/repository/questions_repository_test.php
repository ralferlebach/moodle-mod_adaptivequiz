...
final class questions_repository_test extends advanced_testcase {
    ...
    public function test_it_can_count_questions_number_per_difficulty(): void {
        ...
        $draftquestion = $questionsgenerator->create_question(
            'truefalse',
            null,
        ...
        $hiddenquestion = $questionsgenerator->create_question(
            'truefalse',
            null,
    ...
    public function test_it_finds_questions_with_tags(): void {
        ...
        $question1 = $questionsgenerator->create_question(
            'truefalse',
            null,
        ...
        $question2 = $questionsgenerator->create_question(
            'truefalse',
            null,
