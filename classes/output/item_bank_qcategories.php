...
class item_bank_qcategories implements renderable, templatable {
    ...
    public function __construct(
        /** @var stdClass $adaptivequiz The adaptive quiz instance record. */
        public readonly stdClass $adaptivequiz,
        /** @var cm_info $cm Course module of the adaptive quiz instance. */
