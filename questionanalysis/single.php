...
/**
 * Shows the analysis of a single question of an adaptive quiz.
 *
...
$PAGE->set_url('/mod/adaptivequiz/questionanalysis/single.php', ['cmid' => $cm->id, 'qid' => $qid]);
...
$url = new moodle_url(
    ...
    ['cmid' => $cm->id, 'sort' => $sort, 'sortdir' => $sortdir, 'page' => $page]
);
...
$reporttable = $output->get_single_question_report(
    $headers,
    $record,
    $cm,
    '/mod/adaptivequiz/questionanalysis/overview.php',
